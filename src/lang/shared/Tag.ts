...
export class Tag {
    ...
    static Remainder = this.create("%", "Remainder")
...
export const SecondaryArithmeticalTags = [Tag.Multiplication, Tag.Division, Tag.Remainder]

export const ArithmeticalTags = [Tag.Addition, Tag.Subtraction, Tag.Multiplication, Tag.Division, Tag.Remainder]
export const NumberTags = [Tag.Integer, Tag.Float]

export const UnaryTags = [Tag.BooleanNot, Tag.Addition, Tag.Subtraction]
export const UpdateTags = [Tag.Increment, Tag.Decrement]
